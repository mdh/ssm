...
If you like to separate your state machine from your model, you can do so as following:
...
If you are using Rails/ActiveRecord you can generate a graphviz chart of the state machine via rake.
For details run:
