...
==== example
  ...
  def activate_account(activation_code)
    # do some stuff like sending mails, no need to add these in callbacks
    # or add validation errors if using ActiveRecord / ActddiveModel
    errors.add(:activation_code, 'Invalid') if activation_code_invalid?(activation_code)
  end
